...
Reading about listening can only get someone so far — watching it demonstrated, then talking about it, is the surest way. Three approaches that jump-started practical skill (paraphrased from an HN commenter):

- [Reflective listening](https://en.wikipedia.org/wiki/Reflective_listening) — Carl Rogers' lineage.
- [Clean language](https://en.wikipedia.org/wiki/Clean_language) — David Grove's technique for not contaminating the speaker's experience with your own metaphors.
- Gendlin's Focusing itself (this note).

The shared umbrella term is "holding space". Simple, open-ended, genuine questions worded in the speaker's _own_ language create a non-judgemental space where people open up from the bottom of their souls. Astonishing what the simple act of listening enables.
